...
Reports are kept confidential to the extent compatible with a thorough investigation. The maintainers will:
  ...
  1. acknowledge receipt of the report within seven (7) days;
  2. investigate the facts in a fair, impartial and timely manner;
  3. notify the reporter when the matter is resolved, subject to privacy constraints; and
  4. where appropriate, take action in accordance with Section 5.

Reports made in good faith will not be met with retaliation.
...
Actions are graduated according to the severity and repetition of the conduct:

  - **Correction.** A private, written request to stop the offending behaviour, with guidance on how to comply.
  - **Warning.** A formal written warning that records the conduct and the consequences of any repetition.
  - **Temporary restriction.** Removal of contribution or moderation privileges for a defined period, typically between seven (7) and ninety (90) days.
  - **Permanent ban.** Removal of all contributor and community access, reserved for severe or repeated violations.

Severe or repeated violations may result in immediate permanent removal without prior escalation.
...
## 8. Versioning
This Code of Conduct is versioned together with the License. Aligned with the **Datacustodia Dataset License Version 1 (DDL-v1)**. Substantive amendments require the same review and approval process as the License itself.